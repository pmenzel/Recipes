...
```{r composite_plots_sharedlegend_cowplot, fig.height=5, fig.width=10, message=FALSE}
library(cowplot)
...
```{r composite_plots_sharedlegend_patchwork, fig.height=5, fig.width=10, message=FALSE}
...
```{r composite_plots_insetlegend_patchwork, fig.height=5, fig.width=10}
p1 <- ggplot(mpg) +
  geom_point(aes(x=displ,y=hwy,color=manufacturer)) +
  theme_bw() +
